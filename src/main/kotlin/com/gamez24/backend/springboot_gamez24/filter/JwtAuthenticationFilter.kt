package com.gamez24.backend.springboot_gamez24.filter
...
class JwtAuthenticationFilter(
    ...
    override fun doFilterInternal(
        ...
        if (servletPath.contains("/users/login") || servletPath.contains("/users/signup")) {
    ...
    private fun extractJwtFromRequest(request: HttpServletRequest): String? {
        ...
        request.cookies?.let { cookies ->
            cookies.find { it.name == "jwt" }?.let { cookie ->
                return cookie.value
            }
        }
